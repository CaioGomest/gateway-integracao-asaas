...
<div class="row">
    ...
    <?php
// Garante que a variável esteja definida para evitar erro de "undefined variable"
$saldoBaixo = false; // Você pode substituir essa lógica com base no saldo real do usuário
?>
...
<div class="modal-body px-4">
    ...
    <div class="modal-footer">
        ...
        <?php
        // Garante que a variável $count esteja definida para evitar warning
        $count = $count ?? 0;
        ?>
