                ...
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        <div>
                            ...
                            <h5 class="mb-4 fs-4"><?php echo safe_number_format($total_saldo, 2, ',', '.'); ?></h5>
                        </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        <div>
                            <span class="d-block mb-2">Lucro Liquido</span>
                            <h5 class="mb-4 fs-4"><?php echo safe_number_format($total_month, 2, ',', '.'); ?></h5>
                        </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        <div>
                            <span class="d-block mb-2">Lucro Liquido</span>
                            <h5 class="mb-4 fs-4"><?php echo safe_number_format($total, 2, ',', '.'); ?></h5>
                        </div>
                ...
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        <div>
                            ...
                            <h5 class="mb-4 fs-4"><?php echo safe_number_format($total_today, 2, ',', '.'); ?></h5>
                        </div>
                        <span class="text-success me-2 fw-medium d-inline-block"></span><span class="text-muted">Hoje</span>
                    </div>
                    <div>
