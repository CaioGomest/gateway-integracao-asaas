            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        <div>
                            <span class="d-block mb-2">Valor aprovado</span>
                            <h5 class="mb-4 fs-4"><?php echo safe_number_format($valorSaqueAprovadoTotal, 2, ',', '.'); ?></h5>
                        </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        <div>
                            <span class="d-block mb-2">Valor aprovado</span>
                            <h5 class="mb-4 fs-4"><?php echo safe_number_format($valorSaqueAprovadoHoje, 2, ',', '.'); ?></h5>
                        </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        <div>
                            <span class="d-block mb-2">Valor aprovado</span>
                            <h5 class="mb-4 fs-4"><?php echo safe_number_format($valorSaqueAprovadoMes, 2, ',', '.'); ?></h5>
                        </div>
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    <strong>Total Cash Out Bruto:</strong> R$ <?= safe_number_format($total_cash_out_bruto_filtrada, 2, ',', '.') ?><br>
                    <strong>Total Cash Out Líquido:</strong> R$ <?= safe_number_format($total_cash_out_liquido_filtrado, 2, ',', '.') ?><br>
                    <strong>Total Bruto de Lucro para a Plataforma:</strong> R$ <?= safe_number_format($lucro_plataforma_filtrada, 2, ',', '.') ?>
                </div>
